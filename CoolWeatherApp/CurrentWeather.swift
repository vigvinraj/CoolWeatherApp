...
class CurrentWeather {
    ...
    func downloadWeatherDetails(completed: DownloadComplete) {
        //Alamofire download
        let currentWeatherURL = NSURL(string: Location.sharedInstance.CURRENT_WEATHER_URL)
        ...
        Alamofire.request(.GET, currentWeatherURL!).responseJSON { response in
            ...
            if let dict = result.value as? Dictionary<String, AnyObject> {
                ...
                if let name = dict["name"] as? String {
                    ...
                    self._cityName = name.capitalizedString
                    print(self.cityName)
                ...
                if let weather = dict["weather"] as? [Dictionary<String,AnyObject>] {
                    ...
                    if let main = weather[0]["main"] as? String {
                        ...
                        self._weatherType = main.capitalizedString
